          ...
          <div style={{ paddingRight: '2rem' }}>
            ...
            <section style={{ marginBottom: '2rem' }}>
              ...
              <div style={{ background: 'rgba(255, 255, 255, 0.03)', borderRadius: '12px', padding: '1rem' }}>
                ...
                <p style={{ marginBottom: '0.5rem' }}><strong>📜 Contract V2:</strong> <code style={{ background: 'rgba(0,0,0,0.3)', padding: '0.2rem 0.5rem', borderRadius: '4px' }}>0x9217CaCEa3Eeaf1Fb941c4Fdc17d165248Dd896f</code></p>
                <p style={{ marginBottom: '0.5rem' }}><strong>🔍 ReefScan:</strong> <a href="https://reefscan.com/contract/0x9217CaCEa3Eeaf1Fb941c4Fdc17d165248Dd896f" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--reef-pink)' }}>Verify Contract</a></p>
