          ...
          <div style={{ paddingRight: '2rem' }}>
            ...
            <section style={{ marginBottom: '2rem' }}>
              ...
              <div style={{ background: 'rgba(255, 255, 255, 0.03)', borderRadius: '12px', padding: '1rem' }}>
                ...
                <p style={{ marginBottom: '0.5rem' }}><strong>📜 Contract:</strong> <code style={{ background: 'rgba(0,0,0,0.3)', padding: '0.2rem 0.5rem', borderRadius: '4px' }}>0xFdD061cBE98ef3D1f2a2d7A5e8e14CA57e3baA48</code></p>
                <p style={{ marginBottom: '0.5rem' }}><strong>🔍 ReefScan:</strong> <a href="https://reefscan.com/contract/0xFdD061cBE98ef3D1f2a2d7A5e8e14CA57e3baA48" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--reef-pink)' }}>Verify Contract</a></p>
